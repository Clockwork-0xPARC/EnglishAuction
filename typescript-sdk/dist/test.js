    ...
    for (const letter of word) {
        ...
        for (let i = 0; i < myTilesRemaining.length;) {
            ...
            if (tile.letter == letter) {
                tilesChosen.push(Object.assign({}, tile));
...
const findRedeemableWord = (myTiles, words) => {
...
const client = new _1.EAClient("english-auction.spacetimedb.net:3000", "english-auction");
